...
def upgrade() -> None:
    ...
    op.create_index('idx_agent_schedules_next_run', 'agent_schedules', ['is_enabled', 'next_run_at'], unique=False)
    op.create_index('idx_agent_schedules_workspace', 'agent_schedules', ['workspace_id'], unique=False)
    ...
    op.create_table('continuous_targets',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('workspace_id', sa.UUID(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index('idx_agent_schedules_workspace', table_name='agent_schedules')
    op.drop_index('idx_agent_schedules_next_run', table_name='agent_schedules')
