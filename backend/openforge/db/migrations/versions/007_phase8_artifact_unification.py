"""Phase 8 Artifact Unification

Revision ID: 007_phase8_artifact_unification
Revises: 006_phase7_profile_core
Create Date: 2026-03-14

Phase 8 upgrades the thin artifact CRUD model into a versioned artifact system with:
    ...
    for row in rows:
        ...
        bind.execute(
            artifact_versions.insert().values(
                ...
                summary=row.summary,
                change_note="Phase 8 backfill from legacy artifact row",
