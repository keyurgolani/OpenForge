...
class LLMProvider(Base):
    ...
    router_config: Mapped[Optional["LLMRouterConfig"]] = relationship(back_populates="provider", uselist=False)
    council_config: Mapped[Optional["LLMCouncilConfig"]] = relationship(back_populates="provider", uselist=False)
