...
PROMPT_CATALOGUE: list[dict[str, Any]] = [
    ...
    _entry(
        ...
        (
            ...
            "### Knowledge retrieval\n"
            "You do NOT receive automatic knowledge context. When the user's question may relate to "
            "stored knowledge, notes, bookmarks, or past conversations, proactively call `workspace__search` "
            "with a descriptive query. If the first search returns no useful results, rephrase your query "
            "and try again with different keywords before concluding the information is not available.\n\n"
            "### `filesystem__*`\n"
