"""Model Policy domain service."""

from openforge.domains.common.crud import CrudDomainService
from openforge.db.models import ModelPolicyModel


class ModelPolicyService(CrudDomainService):
    """Service for managing model policies."""
