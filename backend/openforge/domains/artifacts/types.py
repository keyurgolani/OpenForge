...
class ArtifactStatus(str, Enum):
    """Lifecycle status of an artifact or artifact version."""
...
class ArtifactVisibility(str, Enum):
    """Visibility for artifact browsing and publishing workflows."""
...
class ArtifactCreationMode(str, Enum):
    """How an artifact entered the system."""
...
class ArtifactObjectType(str, Enum):
    """Objects that can participate in artifact lineage."""
...
class ArtifactSinkType(str, Enum):
    """Destination classes for artifact publication/sync."""
...
class ArtifactVersion(BaseModel):
    """Version snapshot for an artifact."""
...
class ArtifactSink(BaseModel):
    """Destination or export state for an artifact."""
