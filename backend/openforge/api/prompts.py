...
PROMPT_CATALOGUE = [
    ...
    },
    {
        ...
        "default": (
            ...
            "- `workspace.delete_knowledge` — remove a knowledge record (ONLY when user explicitly asks to delete)\n"
            ...
            "Use `workspace.list_knowledge` or `workspace.search` to find it first, confirm the match with the user if ambiguous, "
            "then call `workspace.delete_knowledge` with the exact ID from the search result.\n\n"
            "## @Mention delegation\n"
