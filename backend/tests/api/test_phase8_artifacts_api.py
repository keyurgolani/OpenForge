...
class ArtifactPhase8StubService:
...
def create_client() -> TestClient:
    ...
    app.dependency_overrides[get_artifact_service] = lambda: ArtifactPhase8StubService()
    return TestClient(app)


def test_artifact_versions_endpoint_returns_phase8_shape() -> None:
