...
class WorkflowCompositeStubService:
    ...
    async def get_workflow(self, workflow_id):
        ...
        return {
            ...
            "current_version": {
                ...
                "status": "active",
                "change_note": "Composite workflow template",
                "nodes": [
                    entry_node
                ],
                "edges": [],
...
def create_client() -> TestClient:
    ...
    app.dependency_overrides[get_workflow_service] = lambda: WorkflowCompositeStubService()
    app.dependency_overrides[get_run_service] = lambda: RunCompositeStubService()
    return TestClient(app)


def test_workflow_templates_endpoint_returns_composite_template_shape() -> None:
