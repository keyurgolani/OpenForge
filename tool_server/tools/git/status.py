...
class GitStatusTool(BaseTool):
    @property
    def id(self): return "git.status"

    @property
    def category(self): return "git"

    @property
    def display_name(self): return "Git Status"

    @property
    def description(self): return "Show the working tree status of the workspace git repository."
