...
function OllamaNativeSection({ capability, configuredModels, systemProviderId, onAddModel }: OllamaNativeSectionProps) {
    ...
    const installedSet = useMemo(() => {
        ...
        for (const m of installedModels) set.add(m.name)
        return set
    }, [installedModels])
