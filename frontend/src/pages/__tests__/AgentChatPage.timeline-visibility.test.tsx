            ...
            messages: [
              {
                ...
                timeline: [
                  { type: 'thinking', content: 'Internal thought', durationMs: 1200, done: true },
                  { type: 'tool_call', call_id: 'call-1', tool_name: 'workspace.search', arguments: { query: 'AI agents' }, success: true, output: { results: [] } },
...
describe('AgentChatPage workflow visibility', () => {
  ...
  it('keeps assistant workflow traces out of the chat transcript', () => {
    render(
    ...
    // The final answer must be visible
    expect(screen.getByText((text) => text.includes('Final assistant answer.'))).toBeInTheDocument()
