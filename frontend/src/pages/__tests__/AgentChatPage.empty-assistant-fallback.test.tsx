      ...
      if (scope === 'global-conversations' && category === 'chats') {
        return {
          data: [
            {
              id: 'conv-1',
              title: 'Missing final answer thread',
              message_count: 2,
...
describe('AgentChatPage empty assistant fallback', () => {
  beforeEach(() => {
  ...
  it('shows a neutral fallback instead of leaking an intermediate response', () => {
    render(
