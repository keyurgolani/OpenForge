...
type AgentEventMap = {
  ...
  tool_call_result: [data: { call_id: string; success: boolean; output?: unknown; error?: string | null; duration_ms?: number | null; nested_timeline?: unknown[] | null; delegated_conversation_id?: string | null }]
