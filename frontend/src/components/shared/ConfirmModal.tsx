                    ...
                    >
                        ...
                        <div className="flex gap-3 mt-6 justify-end">
                            <button
                                ...
                                onClick={onClose}
                                disabled={loading}
                                className="px-4 py-2 text-sm font-medium rounded-xl border border-border/25 bg-card/50 text-foreground hover:bg-muted/50 transition-colors disabled:opacity-50"
                            >
                                {cancelLabel}
                            </button>
                            <button
