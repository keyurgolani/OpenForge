...
import { Loader2, Save, Upload, X, FileType2 } from 'lucide-react'
...
export default function PDFCreateModal({ isOpen, onClose, workspaceId, onCreated }: PDFCreateModalProps) {
                ...
                {file ? (
                    <div className="flex items-center gap-3 w-full p-3">
                        <div className="w-16 h-16 rounded-lg bg-muted/40 border border-border/60 flex items-center justify-center flex-shrink-0">
                            <FileType2 className="w-7 h-7 text-red-400" />
                        </div>
