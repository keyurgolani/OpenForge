...
export default function VideoCreateModal({ isOpen, onClose, workspaceId, onCreated }: VideoCreateModalProps) {
            ...
            >
                ...
                {file ? (
                    <div className="flex items-center gap-3 w-full p-3">
                        {preview ? (
                            <video src={preview} className="w-24 h-16 rounded-lg object-cover flex-shrink-0 border border-border/20" muted />
                        ) : (
                    ...
                    <div className="flex flex-col items-center gap-2 text-center p-6">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-0.5">MP4, MOV, AVI, MKV, WebM</p>
                        </div>
                    </div>
                )}
            </div>
