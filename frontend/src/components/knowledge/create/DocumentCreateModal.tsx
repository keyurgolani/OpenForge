...
export default function DocumentCreateModal({ isOpen, onClose, workspaceId, onCreated }: DocumentCreateModalProps) {
        ...
        >
            ...
            >
                <input
                    ref={fileInputRef}
                    type="file"
                    accept={ACCEPTED_MIMES.document}
                ...
                {file ? (
                    ...
                    <div className="flex flex-col items-center gap-2 text-center p-6">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-0.5">Document (.docx, .doc)</p>
                        </div>
                    </div>
                )}
            </div>
