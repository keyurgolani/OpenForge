    ...
    return (
        ...
        >
            ...
            <textarea
                ...
                className="w-full bg-muted/20 border border-border/25 rounded-xl p-3 text-sm font-mono resize-none outline-none focus:border-accent/50 transition-colors"
                rows={12}
                spellCheck={false}
                autoFocus
            />
