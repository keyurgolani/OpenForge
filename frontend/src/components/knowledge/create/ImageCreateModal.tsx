...
export default function ImageCreateModal({ isOpen, onClose, workspaceId, onCreated }: ImageCreateModalProps) {
                ...
                {file ? (
                    ...
                    <div className="flex flex-col items-center gap-2 text-center p-6">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-0.5">Image</p>
                        </div>
                    </div>
                )}
            </div>
