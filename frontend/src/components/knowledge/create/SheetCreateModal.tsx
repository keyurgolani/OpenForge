...
export default function SheetCreateModal({ isOpen, onClose, workspaceId, onCreated }: SheetCreateModalProps) {
                ...
                {file ? (
                    ...
                    <div className="flex flex-col items-center gap-2 text-center p-6">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-0.5">Sheet (.xlsx, .xls)</p>
                        </div>
                    </div>
                )}
            </div>
