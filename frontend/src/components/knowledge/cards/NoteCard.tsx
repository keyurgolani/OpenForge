    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            {item.content_preview && (
                <div
                    className="text-[13px] text-foreground/80 line-clamp-4 leading-relaxed prose prose-invert prose-p:my-0 prose-headings:my-0 prose-headings:text-[13px] prose-headings:font-medium prose-li:my-0 prose-ul:my-0 max-w-none"
