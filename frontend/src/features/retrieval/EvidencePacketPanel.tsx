        ...
        <div className="space-y-4">
            <div className="space-y-2">
                <div className="flex items-center justify-between gap-3">
                    ...
                    {query && (
                        <span className="rounded-full border border-border/25 bg-muted/40 px-2 py-1 text-[11px] text-muted-foreground">
                            {query.id.slice(0, 8)}
                        </span>
                    )}
                </div>
            ...
            {query && (
                <div className="rounded-xl border border-border/20 bg-muted/20 p-3 space-y-2">
            ...
            {!activeResult && !loading && (
                <div className="rounded-xl border border-dashed border-border/25 bg-muted/10 p-4 text-sm text-muted-foreground">
                ...
                <div className="space-y-3">
                    <div className="rounded-xl border border-border/20 bg-muted/20 p-3 space-y-2">
                        <div className="flex items-start justify-between gap-3">
                            ...
                            <span className="rounded-full border border-border/25 px-2 py-0.5 text-[10px] uppercase tracking-wide text-muted-foreground">
                    ...
                    <div className="space-y-2">
                        ...
                        <div
                            className="rounded-xl border border-border/20 bg-background/70 p-3 text-sm text-foreground/90 markdown-content"
                    ...
                    {readResult.parent_excerpt && (
                        <div className="space-y-2">
                            ...
                            <div
                                className="rounded-xl border border-border/20 bg-muted/10 p-3 text-xs text-foreground/80 markdown-content"
            ...
            {evidence && (
                <div className="space-y-3 rounded-xl border border-border/20 bg-accent/5 p-3">
                    <div className="flex items-center justify-between gap-3">
                        <div>
                    ...
                    {evidence.packet.items.map(item => (
                        <div key={item.id} className="rounded-lg border border-border/25 bg-background/70 p-3 space-y-2">
